...
# URL Streamlit Cloud: https://cgoniec-spotify-analyst-app-app-2vciw5.streamlit.app/
# URL GitHub: https://github.com/CGoniEc/Spotify-Analyst-App/tree/main
...
17. **PREGUNTAS FUERA DE DOMINIO**:
    - Si el usuario hace preguntas que no estén relacionadas con la música, con sus hábitos de escucha o con el análisis de los datos de Spotify disponibles en el DataFrame, NO debes inventar código ni responder a la pregunta.
    - En su lugar, debes responder educadamente indicando que tu única función es ser un analista de datos de música y Spotify.

## FORMATO DE RESPUESTA:
Debes responder ESTRICTAMENTE con un objeto JSON que siga una de estas estructuras dependiendo del caso:

**Si la pregunta es válida y genera un gráfico:**
{{
  "tipo": "grafico",
...
**Si la pregunta está fuera de dominio (Regla 17):**
{{
  "tipo": "fuera_de_alcance",
  "codigo": "",
  "interpretacion": "Lo siento, mi función en esta aplicación es actuar exclusivamente como tu analista de datos de música y Spotify. No puedo responder a preguntas sobre otros temas."
}}
"""
...
#
#    [La arquitectura es un pipeline donde el usuario pide un análisis en lenguaje natural y la app devuelve una visualización.
#     El LLM recibe la pregunta del usuario junto al System Prompt (con las columnas de df disponibles y reglas de negocio).
#     Devuelve un objeto JSON con el código de Plotly Express y una interpretación de lo que está generando.
#     El código generado por el LLM se ejecuta localmente en el entorno de Python usando la función exec().
#     El LLM no recibe los datos directamente porque saturaría su ventana de contexto y generaría costes innecesarios de API; 
#     por privacidad de los datos que se estén utilizando y porque Pandas en local procesa millones de filas de forma mucho más rápida y precisa.]
#
#
